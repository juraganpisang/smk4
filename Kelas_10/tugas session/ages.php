...
<html>
	...
	<body>
		...
		<ul id="horiz">
			<li><a href="profile2.php" id="me">Agestya rizki pratama </hr></a></li>
		...
		<div id="file">
			...
			<p id="namaku"> Agestya rizki pratama </p>
			<p id="date"> Born on August 20-1998 </p>
			<image src="img/mail.png" id="mail" />
			<p id="mail2">agestya78@gmail.com</p>
			<image src="img/maps.png" id="maps" />
			<p id="maps2">On Malang city</p>
		</div>
