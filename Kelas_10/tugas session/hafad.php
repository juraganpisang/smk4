...
<html>
	...
	<body>
		...
		<ul id="horiz">
			...
			<li><a href="profile2.php" id="me">Hafad septiyan</a></li>
		...
		<div id="file">
			...
			<p id="namaku"> Hafad Septiyan </p>
			<p id="date"> Born on September 25 - 1998 </p>
			<image src="img/mail.png" id="mail" />
			<p id="mail2">Septiyanhafad7@gmail.com</p>
			<image src="img/maps.png" id="maps" />
			<p id="maps2">On Bululawang</p>
		</div>
