...
<body>
	...
	<div id="body" class="blog">
		<div>
			<ul>
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelamaris.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 15');
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelregent.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 16');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelgrand.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 17');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelubud.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 18');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelsavana.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 19');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
