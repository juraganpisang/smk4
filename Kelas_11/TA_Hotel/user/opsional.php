...
<body>
	...
	<div id="body" class="blog">
		<div>
			<ul>
				<li>
					<span class="bg-top"></span> <a href=""><img src="../images/hotelharris.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 5');
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelorchid.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 6');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelsolaris.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 7');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelkartika.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 8');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelbest.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 9');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
