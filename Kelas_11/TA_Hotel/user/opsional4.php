...
<body>
	...
	<div id="body" class="blog">
		<div>
			<ul>
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelmax.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 20');
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelbalava.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 21');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hoteltidar.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 22');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelibis.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 23');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelpelangi.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 24');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
