...
<body>
	...
	<div id="body" class="blog">
		<div>
			<ul>
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelhorison.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 10');
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelatria.JPG" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 11');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelaria.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 12');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelpurnama.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 13');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
				...
				<li>
					<span class="bg-top"></span> <a href="#"><img src="../images/hotelsahid.jpg" class="oip"></a>
					<div>
					<h3>
					<?php
					include '../koneksi.php';

					$result=mysql_query('SELECT * FROM tb_hotel WHERE no = 14');
					$row = mysql_fetch_array($result);
					echo $row['nama_hotel']."<br>";
					?></h3>
					<p>
